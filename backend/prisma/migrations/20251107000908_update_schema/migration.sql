...
-- DropForeignKey
ALTER TABLE "VehicleStatus" DROP CONSTRAINT "VehicleStatus_vehicleId_fkey";

-- AlterTable
ALTER TABLE "User" ADD COLUMN     "vehicleId" INTEGER;
...
-- AddForeignKey
ALTER TABLE "VehicleStatus" ADD CONSTRAINT "VehicleStatus_vehicleId_fkey" FOREIGN KEY ("vehicleId") REFERENCES "Vehicle"("id") ON DELETE CASCADE ON UPDATE CASCADE;
